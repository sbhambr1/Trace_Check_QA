...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="meta-llama/Llama-3.2-1B-Instruct", help="Base model ID.") # meta-llama/Llama-3.2-1B-Instruct, Qwen/Qwen3-1.7B
    parser.add_argument("--adapter_path", type=str, default="Llama-3.2-1B-Instruct-sft-adapter-reasoning-facts", help="SFT model adapter dir path.")
