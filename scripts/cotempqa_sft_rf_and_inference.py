...
def train_sft(
    ...
    mode: str = "default", # Mode for prompt generation   
):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--expt_name", type=str, default="llama3.1-8b-sft-cotempqa", help="Experiment name for saving logs.")
    ...
    train_sft(
        ...
        mode="default", # Set to "default" or "cotempqa" based on your needs
    )
