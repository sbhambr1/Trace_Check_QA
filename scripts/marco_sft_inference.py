...
import argparse
from scripts.marco_config import *
...
def evaluate_marco_sft_model(
    ...
    data_path: str = "./data/marcoqa/test.csv",
    mode: str = "default",
    output_dir: str = "results/marcoqa/evaluation_outputs/default/",
    evaluate_result_dir: str = "results/marcoqa/evaluation_results/default/",
):
    all_data = []
    ...
    test_csv_path = os.path.join(os.getcwd() + '/data/marcoqa/sft_dataset_chat_template/test.csv')
    test_samples = []
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate the MarcoQA SFT model.")
    ...
    parser.add_argument("--data_path", type=str, default="data/marcoqa/ans.json", help="Path to the dataset file.")
    parser.add_argument("--mode", type=str, default="few_shot_cot", help="Mode for evaluation.")
    parser.add_argument("--output_dir", type=str, default="results/marcoqa/evaluation_outputs/default/", help="Output directory.")
    parser.add_argument("--evaluate_result_dir", type=str, default="results/marcoqa/evaluation_results/default/", help="Path to save the evaluation result.")
    
    args = parser.parse_args()
    
    evaluate_marco_sft_model(args.model_name, args.adapter_path, args.data_path, args.mode, args.output_dir, args.evaluate_result_dir)
