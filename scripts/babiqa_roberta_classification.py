...
LABEL_MAPPING = {
    "single-supporting-fact": 0,
    "two-supporting-facts": 1,
    "two-arg-relations": 2,
    "counting": 3,
    "lists-sets": 4,
    "conjunction": 5,
    ...
    "basic-deduction": 7,
    "basic-induction": 8,
    "positional-reasoning": 9,
    "size-reasoning": 10,
}


LABEL_REVERSE_MAPPING = {
    0: "single-supporting-fact",
    1: "two-supporting-facts",
    2: "two-arg-relations",
    3: "counting",
    4: "lists-sets",
    5: "conjunction",
...
def main(cuda_device, num_labels, max_len, batch_size, num_epochs, model_name, lr, storage_dir, dataset_path):
    ...
    model_save_name = "babiqa/" + model_name.replace("/", "_") + "/" + time.strftime("%Y%m%d-%H%M%S")
...
if __name__ == '__main__':  
    ...
    ArgumentParser.add_argument('--num_labels', type=int, default=11, help='Number of labels for classification')
    ...
    dataset_path = os.path.join(os.getcwd(), "data/babiqa")
