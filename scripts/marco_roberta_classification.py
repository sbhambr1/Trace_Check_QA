...
def main(cuda_device, num_labels, max_len, batch_size, num_epochs, model_name, lr, storage_dir, dataset_path):
    ...
    model_save_name = "marcoqa/" + model_name.replace("/", "_") + "/" + time.strftime("%Y%m%d-%H%M%S")
...
if __name__ == '__main__':  
    ...
    ArgumentParser.add_argument('--num_labels', type=int, default=5, help='Number of labels for classification')
    ...
    dataset_path = os.path.join(os.getcwd(), "data/marcoqa")
