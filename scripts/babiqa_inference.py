...
def evaluate_babiqa(model_name, data_path, mode, output_dir, evaluate_result_dir):
    """
...
if __name__ == "__main__":
    ...
    evaluate_babiqa(args.model_name, args.data_path, args.mode, args.output_dir, args.evaluate_result_dir)