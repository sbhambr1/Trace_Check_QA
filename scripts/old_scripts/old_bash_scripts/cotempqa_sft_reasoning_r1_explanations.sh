...
python scripts/cotempqa_sft_reasoning_r1_explanations.py \
    --model_id "$model_id" \
    --expt_name "${model_name}-sft-cotempqa-reasoning-r1-explanations" \
    --output_dir "cotempqa/${model_name}-sft-adapter-reasoning-r1-explanations" \
