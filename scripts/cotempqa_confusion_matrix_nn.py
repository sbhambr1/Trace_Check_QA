...
def main(adapter_name):
    ...
    total_accuracies['category_accuracy'] = total_accuracies['category_accuracy']
    total_accuracies['fact_accuracy'] = total_accuracies['fact_accuracy']
    total_accuracies['answer_accuracy'] = total_accuracies['answer_accuracy']
    
    total_matrix1['correct_answer_correct_category'] = total_matrix1['correct_answer_correct_category']
    total_matrix1['correct_answer_incorrect_category'] = total_matrix1['correct_answer_incorrect_category']
    total_matrix1['incorrect_answer_correct_category'] = total_matrix1['incorrect_answer_correct_category']
    total_matrix1['incorrect_answer_incorrect_category'] = total_matrix1['incorrect_answer_incorrect_category']
    
    total_matrix2['correct_answer_correct_fact'] = total_matrix2['correct_answer_correct_fact']
    total_matrix2['correct_answer_incorrect_fact'] = total_matrix2['correct_answer_incorrect_fact']
    total_matrix2['incorrect_answer_correct_fact'] = total_matrix2['incorrect_answer_correct_fact']
    total_matrix2['incorrect_answer_incorrect_fact'] = total_matrix2['incorrect_answer_incorrect_fact']
    
    total_matrix3['correct_answer_correct_trace'] = total_matrix3['correct_answer_correct_trace']
    total_matrix3['correct_answer_incorrect_trace'] = total_matrix3['correct_answer_incorrect_trace']
    total_matrix3['incorrect_answer_correct_trace'] = total_matrix3['incorrect_answer_correct_trace']
    total_matrix3['incorrect_answer_incorrect_trace'] = total_matrix3['incorrect_answer_incorrect_trace']
    ...
    return total_accuracies, total_matrix1, total_matrix2, total_matrix3
...
if __name__ == "__main__":
    ...
    for adapter_name in adapter_names:
        ...
        output_dir = 'results/Cotempqa/confusion_matrix/'
