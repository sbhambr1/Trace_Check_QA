...
python scripts/marco_sft_reasoning_facts_perturbed.py \
    --model_id "$model_id" \
    --expt_name "${model_name}-sft-marcoqa-reasoning-facts-perturbed-3ep" \
    --output_dir "marcoqa/${model_name}-sft-adapter-reasoning-facts-perturbed" \
