...
python scripts/cotempqa_sft_reasoning_summarized_r1_traces.py \
    --model_id "$model_id" \
    --expt_name "${model_name}-sft-cotempqa-reasoning-summarized-r1-traces" \
    --output_dir "cotempqa/${model_name}-sft-adapter-reasoning-summarized-r1-traces" \
